    ...
    <div class="phone-orders-woocommerce_tab-add-order phone-orders-woocommerce__tab">
        ...
        <div class="wrap" id="woo-phone-orders">
			...
			<div class="wpo-order-sidebar d-flex flex-wrap">
			    <div class="meta-box-sortables" v-bind:class="{'order-4': !isOrderFieldsBelowCustomerDetails}">
			    ...
			    <div class="meta-box-sortables order-3" v-show="showPaymentMethods">
        ...
        <div style="clear: both">
            ...
            <add-customer-modal v-bind="addCustomerModalSettings">
                <slot name="add-customer-address-header" slot="add-customer-address-modal-header"></slot>
            ...
            <edit-address-modal v-bind="editAddressModalSettings">
                <slot name="edit-customer-address-header" slot="edit-customer-address-modal-header"></slot>
                <slot name="edit-customer-address" slot="edit-customer-address-modal-footer"></slot>
		<div slot="multi-addresses-select-slot" slot-scope="slotProps">
		    <slot name="multi-addresses-select" v-bind="slotProps"></slot>
		</div>
		<span slot="multi-addresses-buttons-slot" slot-scope="slotProps">
