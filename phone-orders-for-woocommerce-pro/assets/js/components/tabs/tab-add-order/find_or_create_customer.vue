		...
		<div v-if="showOrderHistoryCustomerSummary" class="orders-history-link">
            ...
            <div>
                <div class="order_data_column phone-orders-customer-data-details">
                    <div class="billing-details" data-edit-address="billing" @click.prevent.stop="cartEnabled ? onClick('billing') : null" :class="{'invalid-field': !isValidCustomerValue && !isFilledRequiredFieldsBilling}">
                        <h4>
                            {{ billingDetailsLabel }}
                    ...
                    <span v-show="! customerIsEmpty">
                        ...
                        <div v-show="!hideShippingSection && shipDifferent" @click.prevent.stop="cartEnabled ? onClick('shipping') : null" :class="{'invalid-field': !isValidCustomerValue && !isFilledRequiredFieldsShipping}">
                            <h4>
                                {{ shipDetailsLabel }}
