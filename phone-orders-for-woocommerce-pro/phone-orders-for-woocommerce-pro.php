...
if (
  !in_array(
    ...
    add_action('admin_notices', function () {
        echo '<div class="notice notice-error is-dismissible"><p>' . __('Phone Orders for WooCommerce requires active WooCommerce!',
                'phone-orders-for-woocommerce') . '</p></div>';
    });
    return;
}

define( 'WC_PHONE_ORDERS_BASENAME', plugin_basename( __FILE__ ) );
define( 'WC_PHONE_ORDERS_VERSION', '3.6.11' );
