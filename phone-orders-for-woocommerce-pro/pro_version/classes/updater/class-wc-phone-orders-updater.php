...
class WC_Phone_Orders_Updater {
	...
	private function api_request( $_action, $_data ) {
		...
		if ( $this->api_url == trailingslashit( WC_PHONE_ORDERS_MAIN_URL ) ) {
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( __( 'You do not have permission to install plugin updates', 'phone-orders-for-woocommerce' ),
				__( 'Error', 'phone-orders-for-woocommerce' ), array( 'response' => 403 ) );
		}
