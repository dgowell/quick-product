...
//***********  EDD LICENSE FUNCTIONS END  *************************************************************************************************************************************************************************************************************************************************
	...
	function admin_notices() {
	    ...
	    $license_status = get_option( 'edd_wpo_license_status' );
	    $license_key    = trim( get_option( 'edd_wpo_license_key' ) );
	    ?>
		...
		<div class="notice notice-warning is-dismissible">
		    <p>
			<?php echo sprintf( __( 'License key for Phone Orders has expired. <a href="%s">Click here to renew it.</a>', 'phone-orders-for-woocommerce' ), "https://algolplus.com/plugins/checkout-2/?edd_license_key={$license_key}&download_id=6835") ; ?>
			</a>
		    </p>
		</div>
	    <?php endif; ?>
		...
		<div class="notice notice-warning is-dismissible">
		    <p>
			<?php echo sprintf( __( 'Please, <a href="%s">activate</a> license key for Phone Orders.', 'phone-orders-for-woocommerce' ), "admin.php?page=phone-orders-for-woocommerce#license" ); ?>
		    </p>
		</div>
	    <?php endif; ?>
